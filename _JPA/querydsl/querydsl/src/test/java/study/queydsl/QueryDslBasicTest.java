...
//      count 쿼리
    ...
    public void paging2() {
        ...
        System.out.println("queryResults.getResults().size() = " + queryResults.getResults().size());
    }
    ...
    public void aggregation() {
        ...
        // tuple로 반환. querydsl이 제공하는 tuple 타입.
        // 데이터 타입이 여러가지인 경우 tuple을 사용. 실무에서는 tuple대신 dto로 값을 받음
     ...
     * left join인 경우에만 on절을 통한 join대상 필터링이 의미가 있다.
     *
     */
    @Test
    ...
    public void fetchJoin_X() {
        ...
        assertThat(loaded).as("No Fetch Join").isFalse();
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery("SELECT new study.queydsl.dto.MemberDto(m.username, m.age) FROM Member m",
